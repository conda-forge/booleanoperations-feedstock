About booleanoperations-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/booleanoperations-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/booleanoperations-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add booleanoperations
# for installing globally
pixi global install booleanoperations
```
...
It is possible to list all of the versions of `booleanoperations` available on your platform:
...
```
pixi search booleanoperations --channel conda-forge
```
